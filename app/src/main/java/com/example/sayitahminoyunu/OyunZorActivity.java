...
public class OyunZorActivity extends AppCompatActivity {
        ...
        ButonTahminEt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tahmin<0 || tahmin>100){
                    EditTextSayi.setError("LÜTFEN 0 İLE 100 ARASINDA BİR SAYI GİRİNİZ!!");
                }
                if(tahmin==BilSayi){
                    startActivity(new Intent(OyunZorActivity.this,KazandinActivity.class));
                    finish();
                    return;
                }

                if(tahmin<BilSayi && tahmin>0 && tahmin<100){
                    sayac --;
                ...
                if(sayac==0 && tahmin!=BilSayi){
                    startActivity(new Intent(OyunZorActivity.this,KaybettinActivity.class));
                }
                if(sayac==0 && tahmin==BilSayi)
                {
                    startActivity(new Intent(OyunZorActivity.this,KazandinActivity.class));
