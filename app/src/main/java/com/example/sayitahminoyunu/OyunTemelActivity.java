...
public class OyunTemelActivity extends AppCompatActivity {
        ...
        ButonTahminEt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tahmin<0 || tahmin>10){
                    EditTextSayi.setError("LÜTFEN 0 İLE 10 ARASINDA BİR SAYI GİRİNİZ!!");
                }
                if(tahmin==BilSayi){
                  startActivity(new Intent(OyunTemelActivity.this,KazandinActivity.class));
                  finish();
                  return;
                }

                if(tahmin<BilSayi && tahmin>0 && tahmin<10){
                    sayac --;
                ...
                if(sayac==0 && tahmin!=BilSayi){
                    startActivity(new Intent(OyunTemelActivity.this,KaybettinActivity.class));
                }
                if(sayac==0 && tahmin==BilSayi)
                {
                    startActivity(new Intent(OyunTemelActivity.this,KazandinActivity.class));
